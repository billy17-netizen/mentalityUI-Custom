        ...
        Library.Notification = function(self, Data)
            ...
            local Items = { } do 
                ...
                Items["OverlayName"] = Instances:Create("TextLabel", {
                    ...
                    TextSize = 15,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["OverlayName"]:AddToTheme({TextColor3 = "Text"})
            ...
            function OverlayList:SetVisibility(Bool)
                Items["OverlayList"].Instance.Visible = Bool
            end
            ...
            function OverlayList:Add(Text, Value)
                ...
                function Row:Set(Text, Value)
                    RowText.Instance.Text = Text .. (Value and (" ["..Value.."]") or "")
                end

                function Row:SetStatus(Bool)
                    if Bool then 
                        RowText:Tween(nil, {Position = UDim2New(0, 15, 0.5, 0), TextTransparency = 0})
                        RowAccent:Tween(nil, {BackgroundTransparency = 0})
                    else
                        RowText:Tween(nil, {Position = UDim2New(0, 0, 0.5, 0), TextTransparency = 0.3})
                        RowAccent:Tween(nil, {BackgroundTransparency = 1})
                    end
                end
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Content"] = Instances:Create("Frame", {
                    ...
                    Position = UDim2New(0, 56, 0, 55),
                    Size = UDim2New(1, -56, 1, -55),
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    ClipsDescendants = true,
                    BackgroundColor3 = FromRGB(27, 25, 29)
            ...
            function Window:UpdateTabs(CurrentAlignment)
                ...
                elseif CurrentAlignment == "LeftTabs" or CurrentAlignment == "RightTabs" then
                    for Index, Value in Window.Pages do
                        Value.Items.Inactive.Instance.Parent = Items[CurrentAlignment].Instance
                        Value.Items.Inactive.Instance.Size = UDim2New(1, 0, 0, 40)
...
Position = UDim2New(0.5, 0, 0.5, 0),
                ...
                DashItems["Text"] = Instances:Create("TextLabel", {
                    ...
                    TextColor3 = FromRGB(240, 240, 240),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Text = DashPage.Name, Visible = false,
                    AutomaticSize = Enum.AutomaticSize.X,
                    AnchorPoint = Vector2New(0, 0.5),
                    Size = UDim2New(0, 0, 0, 15),
                    BackgroundTransparency = 1,
        ...
        Library.Sections.GroupBox = function(self, Data)
            ...
            function GroupBox:RefreshPosition(Bool)
                for _, Elem in pairs(GroupBox.Elements) do
    ...
    Library.CreateSettingsPage = function(self, Window, KeybindList, Options)
        ...
        local UISection = Page:Section({Name = "Appearance", Icon = "palette", Side = 1}) do
            ...
            UISection:Slider({
                Name = "Background Transparency", Default = 0.5,
                Decimals = 0.01,
                Max = 1,
                Min = 0,
                Suffix = "%",
